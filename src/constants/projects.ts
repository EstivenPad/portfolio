...
export const PROJECTS:Project[] = [
    ...
    },
    {
        ...
        description: 'A real estate landing page project developed using the Astro web frameProjects, featuring responsive design and a contact form seamlessly integrated with the EmailJS API for efficient communication management.',
    ...
    },
    {
        ...
        link: 'https://github.com/EstivenPad/Agrosoft',
